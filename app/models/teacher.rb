class Teacher < ActiveRecord::Base
  ...
  has_many :absent_reports, class_name: :SubstituteDetail, foreign_key: :teacher_id
  has_many :substitute_reports, class_name: :SubstituteDetail, foreign_key: :substitute_teacher_id
